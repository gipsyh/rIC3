...
impl TransysUnroll {
    pub fn new(ts: &TransysBuilder) -> Self {
    ...
    pub fn new_with_simple_path(ts: &TransysBuilder) -> Self {
    ...
    pub fn compile(&self) -> TransysBuilder {
    ...
    pub fn interal_signals(&self) -> TransysBuilder {
